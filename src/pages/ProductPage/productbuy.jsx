...
const Productbuy = ({ localStore }) => {
    console.log(localStore.price)
    return (
        <div className="products-page__buy">
            <div className="products-page__buy--top row">
                <div className="products-page__prices">
                    <span className="products-page__price">{localStore.price ? Math.round(localStore.price - (localStore.price / 100) * localStore.discount) : '0'} USD</span>
                    <span className="products-page__prev-price">{localStore.price} USD</span>
                </div>
