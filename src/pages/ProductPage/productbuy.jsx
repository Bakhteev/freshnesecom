    ...
    return (
        <div className="products-page__buy">
            <div className="products-page__buy--top row">
                ...
                <label htmlFor="type" className="products-page__label">
                ...
                <button className="products-page__btn--green flex">
            ...
            <div className="products-page__buy--bottom">
                <button className="products-page__btn">
                    ...
                    <span className="products-page__span">Add to my wish list</span>
                </button>
                <button className="products-page__btn">
                    ...
                    <span className="products-page__span">Compare</span>
                </button>
            </div>
        </div>
    )
